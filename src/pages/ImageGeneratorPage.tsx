...
import { IMAGE_GENERATION_API_URL, IMAGE_PROMPT_API_URL } from '../config/site';
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      if (error instanceof Error && error.name === 'AbortError') {
        ...
        errorMessage =
          'Image generation service is not reachable. Make sure HelioGram backend is running on port 8010.';
