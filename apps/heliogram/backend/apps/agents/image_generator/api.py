...
IMAGE_PROMPT_SYSTEM = """You are a subject-first visual prompt architect for Seedream 4.5.
...
4) Scene routing: infer category (vehicle, architecture exterior, architecture interior, retail/showroom, exhibition booth, product/accessory, packaging, digital interface, fashion/uniform, editorial campaign) and apply matching visual logic.
...
PROMPT_REPAIR_SYSTEM = """You receive leaked policy/instruction text and must rewrite it into one final production-ready image prompt.
