...
import { QUESTIONNAIRE_SECTIONS } from './data';
import { getOverallProgress } from './storage';
                  ...
                  >
                    <div className="flex items-start justify-between gap-4">
                      <div className="flex items-center gap-3">
                        <div className="inline-flex size-11 items-center justify-center rounded-xl bg-yellow-400/10 ring-1 ring-yellow-400/20">
                      ...
                      {isComplete && (
                        <div className="inline-flex items-center gap-1 text-xs font-semibold text-neutral-900">
                    ...
                    <div className="mt-6 pt-4 border-t border-neutral-100 flex items-center justify-between text-sm font-semibold text-neutral-900">
