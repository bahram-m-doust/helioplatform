...
export default function App() {
  ...
  const [pendingQuestionnaireRedirect, setPendingQuestionnaireRedirect] = useState(false);
  ...
  const handleGetStarted = () => {
    ...
    setPendingQuestionnaireRedirect(true);
    openAuthModal();
  };

  useEffect(() => {
    if (isAuthenticated && pendingQuestionnaireRedirect) {
      setPendingQuestionnaireRedirect(false);
      navigate('/questionnaire');
    }
  }, [isAuthenticated, navigate, pendingQuestionnaireRedirect]);
            ...
            <div className="mx-auto max-w-3xl text-center">
              ...
              <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
                <button
                  ...
                  className="bg-yellow-400 hover:bg-yellow-500 text-neutral-900 px-8 py-3 rounded-md text-base font-semibold transition-colors flex items-center gap-2 w-full sm:w-auto justify-center"
                >
                  Get Started
