"""Public request/response schemas for the external storyteller API."""
...
class ChatRequest(BaseModel):
    profile: Literal["Brand Language", "Language Style"] = Field(
        default="Brand Language",
        description="Storyteller profile that selects the underlying voice/style.",
    )
